        ...
        return (
            <PageWrapper>
                <div className="text-center py-20">
                    <h1 className="text-4xl font-bold text-[#1a1814]">Service Not Found</h1>
                    <p className="mt-4 text-lg text-[#6b6258]">The service you are looking for does not exist.</p>
            ...
            <PageWrapper>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    <div className="lg:col-span-2">
                        <h2 className="text-3xl font-bold text-[#1a1814]">Service Overview</h2>
                        <p className="mt-4 text-lg text-[#6b6258]">
                           {service.overview}
                        </p>

                        <h3 className="text-2xl font-bold text-[#1a1814] mt-12">Scope of Work</h3>
                        ...
                        <h3 className="text-2xl font-bold text-[#1a1814] mt-12">Frequently Asked Questions</h3>
                        <div className="mt-4 space-y-6">
                            {service.faqs.map((faq, index) => (
                                <div key={index} className="border-l-4 border-[#2d5a3d] pl-4">
                                    <h4 className="font-semibold text-[#1a1814]">{faq.question}</h4>
                                    <p className="mt-1 text-[#6b6258]">{faq.answer}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <aside className="lg:col-span-1 space-y-8 lg:sticky top-36 h-min">
                        <div className="bg-white border border-[#ddd8cf] p-6 rounded-lg shadow-sm">
                            ...
                            <p className="mt-2 text-[#6b6258]">Get a custom quote for {service.title}.</p>
                            <Link to="/contact" className="mt-4 block w-full text-center bg-[#2d5a3d] text-white font-semibold px-5 py-3 rounded-lg hover:bg-[#1e3e2a] transition-colors duration-300">
                                Contact Sales
                            </Link>
                        </div>
                          ...
                          <div className="bg-white border border-[#ddd8cf] p-6 rounded-lg shadow-sm">
                              ...
                              <ul className="mt-4 space-y-3">
                                  {relatedServices.map(related => (
                                      <li key={related.id}>
                                          <Link to={related.path} className="font-medium text-[#2d5a3d] hover:underline flex justify-between items-center group">
                                            {related.title}
